...
user locales list from HTTP_ACCEPT_LANGUAGE, locale info (in some countries people
...
3. Print available translations, to choose from them manually (and to help search
engines):
...
4. Translations in I18n format are stored in <tt>config/locales/_locale_.yml</tt>:
