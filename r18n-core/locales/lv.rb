...
module R18n
  class Locales::Lv < Locale
    set :title => 'Latviešu',
     ...
     :wday_names => %w{Svētdiena Pirmdiena Otrdiena Trešdiena Ceturtdiena Piektiena Sestdiena},
     ...
     :month_standalone => %w{Janvāris Februāris Marts Aprīlis Maijs Jūnijs Jūlijs
          Augusts Septembris Oktobris Novembris Decembris},
